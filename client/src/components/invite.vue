<template>
  <div class="Login">
    <div>
        ...
        <Row>
        <Col :span="5">
         <Input v-model="input" placeholder="Please enter email id" style="width: 250px"></Input>
        </Col>
        <Col :span="5">
         <Select v-model="value1" style="width:250px" placeholder="Select Role">
            <Option v-for="item in options" :value="item.value1" :key="item.value1">{{ item.label1 }}</Option>
        </Select>
        </Col>
        <Col :span="5">
         <Select v-model="value2" style="width:250px" placeholder="Select subscription">
            <Option v-for="item in options2" :value="item.value2" :key="item.value2">{{ item.label2 }}</Option>
        </Select>
        </Col>
        <Col :span="5">
    ...
    return {
      ...
      columns4: [
        ...
        },
        {
          ...
          key: 'assignDate',
          render: (h, params) => {
            var date1 = moment(params.row.assignDate).format('DD-MMM-YYYY')
                                // return date1
            return h('div', [
              h('span', date1)
            ])
        ...
        },
        {
          ...
          key: 'unassignDate',
          render: (h, params) => {
            var date2 = moment(params.row.unassignDate).format('DD-MMM-YYYY')
            return h('div', [
              h('span', date2)
            ])
          }
        ...
        },
        {
          ...
          key: '',
          render: (h, params) => {
            var now = moment(params.row.assignDate)
            var end = moment(params.row.unassignDate)
            // var duration = moment.duration(now.diff(end))
            var duration = end.diff(now, 'days')
            // console.log('duration....', duration)
            // var days = duration.asDays()
            return h('div', [
              h('span', duration + ' ' + 'days')
            ])
          }
        }
      ]
